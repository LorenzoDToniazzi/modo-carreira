...
const rawWingers: RawPlayer[] = [
  ...
  ["jairzinho", "Jairzinho", "Brasil", "1970–1974", "legend", [90, 86, 82, 84, 78, 91, 92, 88, 80, 86, 84, 90], "Potência em velocidade e presença ofensiva constante fizeram o Furacão marcar em todos os jogos do tri."],
  ...
  ["vini-jr", "Vini Jr.", "Brasil", "2022–2026", "epic", [92, 76, 58, 82, 77, 86, 95, 89, 79, 91, 84, 93], "Arranque repetido, drible em campo aberto e decisão em grandes noites europeias."],
  ["di-maria", "Ángel Di María", "Argentina", "2013–2021", "epic", [84, 76, 61, 82, 87, 86, 87, 85, 88, 86, 84, 87], "Condução, passe final e cruzamento de canhota em múltiplas funções."],
  ["hazard", "Eden Hazard", "Bélgica", "2014–2019", "epic", [86, 78, 66, 80, 83, 85, 89, 91, 78, 92, 85, 92], "Centro de gravidade baixo e domínio do um contra um em espaço curto."],
  ["mane", "Sadio Mané", "Senegal", "2017–2022", "epic", [88, 82, 73, 83, 75, 88, 90, 86, 72, 87, 85, 88], "Profundidade, intensidade sem bola e chegada frequente para finalizar."],
  ["julinho-botelho", "Julinho Botelho", "Brasil", "1954–1960", "epic", [88, 78, 69, 82, 83, 87, 90, 90, 88, 88, 82, 92], "Ponta de técnica, velocidade e cruzamento reconhecido entre os maiores de sua geração."],
  ["canhoteiro", "Canhoteiro", "Brasil", "1955–1963", "epic", [82, 68, 52, 74, 79, 81, 88, 93, 82, 92, 78, 94], "Drible imprevisível e um contra um fizeram dele um dos grandes pontas brasileiros."],
  ...
  ["bruno-henrique", "Bruno Henrique", "Brasil", "2019–2021", "rare", [88, 76, 70, 75, 62, 82, 87, 76, 72, 79, 73, 80], "Velocidade, força e ataque às costas da defesa em jogos grandes."],
  ["dudu", "Dudu", "Brasil", "2016–2022", "rare", [80, 75, 58, 73, 78, 82, 82, 82, 78, 84, 76, 84], "Regularidade, drible e associação como protagonista de um ciclo histórico no Palmeiras."],
  ["eder-aleixo", "Éder Aleixo", "Brasil", "1981–1985", "rare", [80, 75, 68, 84, 77, 79, 82, 79, 86, 78, 87, 81], "Canhota violentíssima, arrancada e cruzamento marcaram a seleção de 1982."],
  ["muller", "Müller", "Brasil", "1987–1993", "rare", [87, 77, 67, 82, 75, 89, 90, 82, 76, 84, 82, 86], "Velocidade, movimentação e decisão fizeram dele peça de grandes times e do tetra."],
  ["paulo-cezar-caju", "Paulo Cézar Caju", "Brasil", "1970–1977", "rare", [80, 77, 65, 80, 85, 83, 82, 86, 84, 84, 82, 86], "Técnica e versatilidade para criar tanto aberto quanto por dentro."],
